...
describe('Bisca game flow (jogar cartas e contar vazas)', () => {
  ...
  it('resolveTrick contabiliza corretamente a vaza quando o player ganha', () => {
    ...
    const playerCard = { id: 1, suit: '♥', rank: 1, points: 11, strength: 10 }
    const botCard = { id: 2, suit: '♥', rank: 11, points: 3, strength: 6 }
  ...
  it('resolveTrick contabiliza corretamente a vaza quando o bot ganha', () => {
    ...
    const playerCard = { id: 1, suit: '♥', rank: 11, points: 3, strength: 6 }
    const botCard = { id: 2, suit: '♥', rank: 1, points: 11, strength: 10 }
