        ...
        <div class="pt-4 border-t border-gray-200">
          ...
          <div class="space-y-4">
            <div>
              ...
              <Input id="currentPassword" v-model="formData.currentPassword" type="password" placeholder="••••••••" />
            </div>
            ...
            <div>
              ...
              <Input id="newPassword" v-model="formData.newPassword" type="password" placeholder="••••••••" />
            </div>
            ...
            <div>
              ...
              <Input id="confirmPassword" v-model="formData.confirmPassword" type="password" placeholder="••••••••" />
            </div>
          </div>
        </div>
