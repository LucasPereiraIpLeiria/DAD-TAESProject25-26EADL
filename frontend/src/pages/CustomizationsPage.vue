    ...
    <div class="max-w-5xl mx-auto p-4 space-y-8">
        ...
        <section>
            ...
            <div class="flex flex-wrap gap-4">
                <CustomizationCard v-for="avatar in avatars" :key="avatar.key" :label="avatar.label"
                    :price="avatar.price" :image="avatar.image" :owned="ownedAvatars.includes(avatar.key)"
                    :selected="selectedAvatar === avatar.key" :is-default="avatar.key === 'default'"
                    @buy="() => openBuyConfirm('avatar', avatar)" @select="() => handleSelect('avatar', avatar)" />
            </div>
        </section>
